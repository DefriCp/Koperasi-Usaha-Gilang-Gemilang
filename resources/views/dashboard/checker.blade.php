  ...
  <x-slot name="header">
    <div class="gg-hero rounded-xl p-6 flex items-center justify-between">
      <div class="flex items-center gap-4">
        ...
        <div>
          <h2 class="text-2xl font-semibold tracking-tight">Dashboard Checker</h2>
          <div class="opacity-90 text-sm">Checker – bisa input & approve / reject pembayaran</div>
        </div>
      </div>
      <span class="gg-pill">Checker</span>
    </div>
  </x-slot>
